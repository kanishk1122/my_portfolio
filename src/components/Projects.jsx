...
const Projects = () => {
  ...
  return (
    <div className="w-full min-h-full flex flex-col justify-start py-4 px-2 items-center text-white">
      ...
      {fullscreenVideo ? (
        (() => {
          const item = allprojectdata.find(
            (i) => i.video_link === fullscreenVideo
          );
          if (!item) return null;
          ...
          return (
            <div className="w-full h-full flex flex-col items-center justify-center p-10">
              ...
              <p className="font-mono text-green-400 mb-8 animate-pulse">
                :: PLAYING PREVIEW ::
              </p>
              <button
            ...
            >
              ...
              <div className="w-full md:w-1/2 flex flex-col gap-4 relative">
                ...
                <div className="flex gap-2 mt-2">
                  <span className="text-[10px] px-2 py-1 rounded border border-white/10 text-zinc-500 uppercase bg-black/20">
                    React
                  </span>
                  <span className="text-[10px] px-2 py-1 rounded border border-white/10 text-zinc-500 uppercase bg-black/20">
                    GSAP
