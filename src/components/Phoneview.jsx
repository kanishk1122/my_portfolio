...
const Phoneview = () => {
    ...
    >
      ...
      >
        {clicked.one ? (
          <div className="w-full max-md:min-h-fit px-6 relative sm:px-24 min-h-fit h-fit flex flex-col justify-start  items-center">
            ...
            <div>
              <div className=" md:mt-[] w-[95.5w] mt-3 py-4  rounded-2xl flex relative justify- items-start bg-[#141414]  md:">
                ...
                <div className="flex flex-wrap  gap-3 z-20 pt-[10%] bg-transparent w-[97vw] h-fit justify-center items-center px-4">
                  {skillsComponents}
                </div>
              </div>
            </div>
          ...
          <div className="duration-300 w-full h-full flex flex-col cursor-pointer justify-center p-3 gap-4 items-center bg-transparent backdrop-blur-xl rounded-xl">
  ...
  `}
      ...
      <div
        ...
        className={`  ${
          clicked.two || clicked.one || clicked.five ? "hidden" : "w-full h-fit"
        }
  ${
    clicked.three
